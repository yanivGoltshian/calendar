...
export function buildClinicLandingContent(): LandingContent {
  return {
    ...
    // המלצות לקוחות — מוצגות כביקורות גוגל בזכות googleReviewsUrl שמופיע בהמשך.
    testimonials: [
      { name: 'מירב ל.', quote: 'טיפול מקצועי ותוצאה טבעית לגמרי. הצוות קשוב ומסביר כל שלב, יצאתי מרוצה ובטוחה. ממליצה בחום.' },
      { name: 'דנה כ.', quote: 'הגעתי לייעוץ והרגשתי ביטחון מהרגע הראשון. התוצאה בדיוק כמו שרציתי, בלי הגזמות.' },
      { name: 'שירן מ.', quote: 'קליניקה נקייה ומזמינה, יחס אישי ומחירים הוגנים. כבר קבעתי טיפול המשך.' },
      { name: 'אורית ב.', quote: 'סוף סוף מקום אסתטיקה מקצועי ביבנה. תודה על הסבלנות, הדיוק והליווי הצמוד.' },
    ],
